...
* Analytify Core (`Free` and Required for all add-ons)
    ...
    * Analytify Pro (*Paid*)
        ...
        * Enhanced E-commerce Google Analytics Tracking for WooCommerce  (*Paid*)
        * Enhanced E-commerce Google Analytics Tracking for Easy Digital Downloads (*Paid*)
